Shader "Custom/NewSurfaceShader" {
	Properties {
		...
		_Metallic ("Metallic", Range(0,1)) = 0.0
			/////////DigitalEmily2_OSL
		DigitalEmily2_OSL__specularUnlitNormTexture____00_specular_unlit.exr("OSL__specularUnlitNormTexture____00_specular_unlit.exr (RGB)", 2D) = "white" {}
		DigitalEmily2_OSL__singleScatterTexture____00_single_scatter.exr("OSL__singleScatterTexture____00_single_scatter (RGB)", 2D) = "white" {}
		DigitalEmily2_OSL__sdiffuseUnlitTexture____00_diffuse_unlit.exr("OSL__sdiffuseUnlitTexture____00 (RGB)", 2D) = "white" {}
